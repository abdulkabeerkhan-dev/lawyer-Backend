...
async def process_query_job(job_id: str, request: QueryRequest, authenticated_user_id: str):
    ...
    try:
        ...
        global_reliability_guard = (
            ...
            f"3. Case Summary in Response: For every case you cite, you must include a comprehensive and detailed 4-to-5 sentence summary covering the complete legal context: the specific case facts, the authoring judge name, key arguments/findings, and the exact ratio decidendi / observational holding. This must be formatted at the end of your response inside a clean markdown block with the header '### Case Summaries'.\n"
